...
def test_train_reshape(train_set,test_set, split_no,sub_seq,steps_out):
...
test_train_reshape(train,test,720,24,steps_out)
...
rmse0.to_csv(r'Monthly_MultiCNNLSTM_Results.csv', index=False, header=True)