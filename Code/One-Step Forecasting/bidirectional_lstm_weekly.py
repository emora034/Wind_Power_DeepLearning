...
rmse0.to_csv(r'Weekly_BiLSTM_Results.csv',
            index=False, header=True)



#record df index where the lowest MAPE is recorded
#rmse0=pd.read_excel('/content/sample_data/Weekly_BiLSTM_Results.xlsx')
...
sns.set(rc={'figure.figsize':(15,5)}, font_scale = 1.58)
fig, ax=plt.subplots()
